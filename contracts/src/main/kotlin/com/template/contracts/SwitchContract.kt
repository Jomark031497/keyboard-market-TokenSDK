...
class SwitchContract : EvolvableTokenContract(), Contract {
    override fun additionalCreateChecks(tx: LedgerTransaction) {
        val newToken = tx.outputStates.single() as SwitchTokenState
        newToken.apply {
    ...
    companion object {
        const val CONTRACT_ID = "com.template.contracts.SwitchContract"
    }
}